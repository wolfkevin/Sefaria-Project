...
var TextSegment = React.createClass({
  ...
  getCurrentVersion: function getCurrentVersion(lang) {
    var d = this.getData();
    if (!d) {
      return null;
    }
  ...
  makeEditable: function makeEditable(lang, event) {
    event.stopPropagation();
    this._setBeingEditedState(lang, true);
  },
  _setBeingEditedState: function _setBeingEditedState(lang, state) {
    var newobj = {};
    newobj[lang] = state;
  ...
  save: function save(lang, event) {
    ...
    Sefaria.postSegment(this.props.sref, v["versionTitle"], lang, v["versionSource"], text, function (e) {
      this._setBeingEditedState(lang, false);
    }.bind(this), function (e) {});
  },
  render: function render() {
    var linkCountElement;
    var editButtonEn = React.createElement('i', { className: 'fa fa-pencil-square-o en', 'aria-hidden': 'true', onClick: this.makeEditable.bind(this, "en") });
    var editButtonHe = React.createElement('i', { className: 'fa fa-pencil-square-o he', 'aria-hidden': 'true', onClick: this.makeEditable.bind(this, "he") });
    var saveButtonEn = React.createElement('i', { className: 'fa fa-floppy-o en', 'aria-hidden': 'true', onClick: this.save.bind(this, "en") });
    var saveButtonHe = React.createElement('i', { className: 'fa fa-floppy-o he', 'aria-hidden': 'true', onClick: this.save.bind(this, "he") });
    ...
    return React.createElement(
      ...
      segmentNumber,
      linkCountElement,
      React.createElement('span', { className: 'he', contentEditable: this.state.beingEdited.he, dangerouslySetInnerHTML: { __html: he + " " } }),
      heButton,
      React.createElement('span', { className: 'en', contentEditable: this.state.beingEdited.en, dangerouslySetInnerHTML: { __html: en + " " } }),
      enButton,
      React.createElement('div', { className: 'clearFix' })
    );
  }
...
var TextList = React.createClass({
  ...
  // should we delay rendering texts until preload is finished
  componentDidMount: function componentDidMount() {
